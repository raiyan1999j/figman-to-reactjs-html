...
export default function Navbar(){
    ...
    return(
        <>
            ...
            "relative bg-bannerBg before:content-'' before:table before:absolute before:w-full before:bg-[#BD1F17]/90 before:h-full before:bg-cover before:-z-30"} smallest:hidden`}>
            ...
            <section className={`w-[390px] mx-auto ${scrollDetection>10?
            "fixed top-0 h-[108px] w-full bg-[#BD1F17]/90 z-50 before:content-'' before:table before:bg-bannerBg before:absolute before:inset-0 before:h-full before:w-full before:-z-30":
            "relative bg-bannerBg before:content-'' before:table before:absolute before:w-full before:bg-[#BD1F17]/90 before:h-full before:bg-cover before:-z-30"} hidden smallest:block`}>
                <nav className=" smallest:w-[390px] h-[108px] mx-auto flex flex-row justify-around items-center text-white">
                    <div className="flex flex-row items-center">
                        <span className="w-[36.99px] h-[37px] mr-[5.99px]">
                            <img src={Logo} alt="logo" className="h-full w-full object-contain"/>
                        </span>
