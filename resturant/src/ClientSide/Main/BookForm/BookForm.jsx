    ...
    return(
        <>
            <section className="w-full bg-bookFormImg bg-cover bg-no-repeat">
                <div className="w-[1320px] mx-auto pt-[120px]">
                    <div className="mb-4">
                    ...
                    <form>
                        <div className="w-[635px] pb-[86px]">
                            <div className="w-full grid grid-cols-[repeat(2,_302.5px)] gap-x-[30px] mb-6">
