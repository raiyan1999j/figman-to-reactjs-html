                ...
                <div className="flex flex-row w-full">
                    <div className="w-[617px] mr-[79px]">
                        <div className="w-[617px] h-[460px] relative">
                            ...
                            <img src={AboutImg} alt="aboutImg" className="h-full w-full object-cover" />
                            </div>
                    ...
                    <div className="w-[624px]">
                        <ul className="flex flex-row gap-x-4 font-robot text-sm font-medium border-[#B52B1D] border-t-0 border-r-0 border-l-0 border capitalize mb-8">
                            <li className="py-[6px] px-4 leading-6 bg-[#B52B1D] text-white">about</li>
                            <li className="py-[6px] px-4 leading-6 text-[#333333]">experience</li>
                            <li className="py-[6px] px-4 leading-6 text-[#333333]">contact</li>
                        </ul>
                        ...
                        <div className="flex flex-row items-center">
                            ...
                            <div className="flex flex-row">
                                <span className="h-6 w-6 mr-2">
                                    <img src={CallLogo} alt="" className="h-full w-full object-contain" />
                                </span>
